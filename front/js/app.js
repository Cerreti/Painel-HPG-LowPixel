...
function showResult() {
  const usuarios = [
    { nome: "Renan Labubu", id: 324 },
    { nome: "Guima Labubu", id: 307 },
    { nome: "Escarlat Paccine", id: 2567 },
    { nome: "Barbara Becker", id: 938 },
    { nome: "Ravine Labubu", id: 637 },
...
async function cadastrar() {
  const funcionario = {
    ...
    responsavel: document.getElementById("user-name")?.innerText || "Desconhecido"
  };
...
window.horaParaSegundos = horaParaSegundos;
